...
class Tinysou_Search_Widget extends WP_Widget {
	function __construct() {
		$widget_ops = array( 'classname' => 'tinysou_serarch_widget', 'description' => __( 'Search content in a specific category' ) );
		parent::__construct( 'tinysou_search_widget', __( 'Category Filtered Search' ), $widget_ops );
	}
...
add_action( 'widgets_init', create_function( '', 'register_widget( "tinysou_search_widget" );' ) );